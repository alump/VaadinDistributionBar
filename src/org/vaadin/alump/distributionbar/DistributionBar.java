...
public class DistributionBar extends AbstractComponent {
    ...
    private static class Part implements Serializable {
        ...
        private static final long serialVersionUID = 4009516719242009675L;
        private int size;
    ...
    public void paintContent(PaintTarget target) throws PaintException {
        ...
        for (int i = 0; i < parts.size(); ++i) {
            ...
            target.addAttribute("psize-" + String.valueOf(i), part.getSize());
            target.addAttribute("ptitle-" + String.valueOf(i), part.getTitle());
     ...
     * 
     * @param amount
     *            Amount of parts in list. If less than two is given value is
     *            read as two.
